...
<div class="hero" style="height: 450px">
	<div class="tab-content container h100 p-0 position-relative" id="">
		...
		<a class="tab-pane show active d-block" id="hero01" role="tabpanel"
			...
			href="${contextPath}/goods/goodsDetail.do?goods_id=201"> <img src="${contextPath}/resources/img/main/hero1.jpg" class="today-image"
			...
			href="${contextPath}/goods/goodsDetail.do?goods_id=202"> <img
			...
			href="${contextPath}/goods/goodsDetail.do?goods_id=301"> <img
			...
			href="${contextPath}/goods/goodsDetail.do?goods_id=101"> <img
			...
			href="${contextPath}/goods/goodsDetail.do?goods_id=102"> <img
		...
		<div
			...
			<a class="list-group-item list-group-item-action p-0 active"
				...
				aria-controls="hero01"> <img src="${contextPath}/resources/img/main/tab1.jpg">
			</a> 
			
			<a class="list-group-item list-group-item-action p-0" id="hero2"
				data-bs-toggle="list" href="#hero02" role="tab"
				aria-controls="hero02"> <img src="${contextPath}/resources/img/main/tab2.jpg">
			</a> 
			
			<a class="list-group-item list-group-item-action p-0" id="hero3"
				data-bs-toggle="list" href="#hero03" role="tab"
				aria-controls="hero03"> <img
				src="${contextPath}/resources/img/main/tab3.jpg">
			</a> 
			
			<a class="list-group-item list-group-item-action p-0" id="hero4"
				data-bs-toggle="list" href="#hero04" role="tab"
				aria-controls="hero04"> <img
				src="${contextPath}/resources/img/main/tab4.jpg">
			</a> 
			
			<a class="list-group-item list-group-item-action p-0" id="hero5"
...
<div class="container">
	<div class="row">
		<div class="d-flex p-0 align-items-center gap-3 mt-5">
			...
			<p class="fs-6">| 오늘 햇빛농장이 엄선한 가장 HOT한 상품!</p>
		</div>
	</div>
		...
		<div class="tab-content border-top border-main border-2 p-0">
			...
			<div class="tab-pane fade show active" id="trend01" role="tabpanel"
				...
				<div class="d-flex justify-content-between">
					...
					<div class="pt-4 pe-5 flex-grow-1 box-sixing-content"
						style="width: 200px">
						<a href="${contextPath}/goods/menuGoods.do?menuGoods=과일"
							class="text-decoration-none">
							<p class="fw-bold fs-4 mb-1">과일</p> <span class="small">바로가기
								> </span>
						</a>
					</div>
					...
					<div
						...
						<c:forEach var="item" items="${goodsMap.cate_fruit}" end="5">
							<c:set var="goods_count" value="${goods_count+1 }" />
							<div>
			...
			<div class="tab-pane fade" id="trend02" role="tabpanel"
				...
				<div class="d-flex justify-content-between">
					...
					<div class="pt-4 pe-5 flex-grow-1 box-sixing-content"
						style="width: 200px">
						<a href="${contextPath}/goods/menuGoods.do?menuGoods=곡류"
							class="text-decoration-none">
							<p class="fw-bold fs-4 mb-1">곡류</p> <span class="small">바로가기
								> </span>
						</a>
					</div>
					...
					<div class="position-relative">
						<img src="${contextPath}/resources/img/main/hot2.jpg"> <a
							href="${contextPath}/goods/menuGoods.do?menuGoods=곡류"
							class="btn btn-main rounded-0 position-absolute bottom-0 start-50 translate-middle z-2 rounded-0 py-3 w100 d-block"
							style="width: 80%">
							<p class="mb-0 fw-bold">곡류</p> <span class="small">햇빛농장이
								필요한것들만 모아놨다!</span>
						</a>
					</div>
					...
					<div
						class="d-flex p-4 pe-0 pb-0 categoryTabGoodList align-items-start flex-wrap"
						style="gap: 1.8rem !important;">
						<c:forEach var="item" items="${goodsMap.cate_grain}" end="5">
							<c:set var="goods_count" value="${goods_count+1 }" />
							<div>
								<a class="text-decoration-none"
									href="${contextPath}/goods/goodsDetail.do?goods_id=${item.goods_id }">
			...
			<div class="tab-pane fade" id="trend03" role="tabpanel"
				...
				<div class="d-flex justify-content-between">
					...
					<div class="pt-4 pe-5 flex-grow-1 box-sixing-content"
						style="width: 200px">
						<a href="${contextPath}/goods/menuGoods.do?menuGoods=채소"
							class="text-decoration-none">
							<p class="fw-bold fs-4 mb-1">채소</p> <span class="small">바로가기
								> </span>
						</a>
					</div>
					...
					<div class="position-relative">
						<img src="${contextPath}/resources/img/main/hot3.jpg"> <a
							href="${contextPath}/goods/menuGoods.do?menuGoods=채소"
							class="btn btn-main rounded-0 position-absolute bottom-0 start-50 translate-middle z-2 rounded-0 py-3 w100 d-block"
							style="width: 80%">
							<p class="mb-0 fw-bold">채소</p> <span class="small">햇빛농장이
								필요한것들만 모아놨다!</span>
						</a>
					</div>
					...
					<div
						class="d-flex p-4 pe-0 pb-0 categoryTabGoodList align-items-start flex-wrap"
						style="gap: 1.8rem !important;">
						<c:forEach var="item" items="${goodsMap.cate_vege}" end="5">
							<c:set var="goods_count" value="${goods_count+1 }" />
							<div>
								<a class="text-decoration-none"
									href="${contextPath}/goods/goodsDetail.do?goods_id=${item.goods_id }">
			...
			<div class="tab-pane fade" id="trend04" role="tabpanel"
				...
				<div class="d-flex justify-content-between">
					...
					<div class="pt-4 pe-5 flex-grow-1 box-sixing-content"
						style="width: 200px">
						<a href="${contextPath}/goods/menuGoods.do?menuGoods=버섯"
							class="text-decoration-none">
							<p class="fw-bold fs-4 mb-1">버섯</p> <span class="small">바로가기
								> </span>
						</a>
					</div>
					...
					<div class="position-relative">
						<img src="${contextPath}/resources/img/main/hot4.jpg"> <a
							href="${contextPath}/goods/menuGoods.do?menuGoods=버섯"
							class="btn btn-main rounded-0 position-absolute bottom-0 start-50 translate-middle z-2 rounded-0 py-3 w100 d-block"
							style="width: 80%">
							<p class="mb-0 fw-bold">버섯</p> <span class="small">햇빛농장이
								필요한것들만 모아놨다!</span>
						</a>
					</div>
					...
					<div
						class="d-flex p-4 pe-0 pb-0 categoryTabGoodList align-items-start flex-wrap"
						style="gap: 1.8rem !important;">
						<c:forEach var="item" items="${goodsMap.cate_mush}" end="5">
							<c:set var="goods_count" value="${goods_count+1 }" />
							<div>
								<a class="text-decoration-none"
									href="${contextPath}/goods/goodsDetail.do?goods_id=${item.goods_id }">
